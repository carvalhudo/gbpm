...
class InitializeRepoTest(TestCase):
    ...
    def test_initialize_repo_with_single_package(
        ...
        pkg_mgr_mock.assert_has_calls(
            [
                call.add_entry(pkg_name, ANY) # TODO: 'fake_hash'
            ]
        )
        ...
        git_mock.assert_has_calls(
            [
                ...
                call.init().create_remote('origin', pkg_repo),
    ...
    def test_initialize_repo_with_multiple_packages(
        ...
        pkg_mgr_mock.assert_has_calls(
            [
                call.add_entry(pkg_names[0], ANY), # TODO: fake_hash
                call.add_entry(pkg_names[1], ANY), # TODO: fake_hash
                call.add_entry(pkg_names[2], ANY), # TODO: fake_hash
                call.add_entry(pkg_names[3], ANY), # TODO: fake_hash
            ]
        )
    ...
    def test_initialize_multiple_repos_with_single_package(
        ...
        WHEN  the user issues an Update/InitializeRepo command.
        THEN  the repositories must be cloned into the package dir in the
              correct branches, the package must be added into the package
    ...
    def test_initialize_multiple_repos_with_multiple_packages(
        ...
        WHEN  the user issues an Update/InitializeRepo command.
        THEN  the repositories must be cloned into the packages dir in the
              correct branches, the packages must be added into the package
    ...
    def test_initialize_multiple_repos_with_no_packages(
        ...
        WHEN  the user issues an Update/InitializeRepo command.
        THEN  the repositories must be cloned into the packages dir in the
              correct branches, no packages must be added into the package
              database and the events must be issued to the view properly.
