...
class MirrorsMgrTest(TestCase):
    ...
    def test_get_multiple_mirrors(self):
        ...
        WHEN  the user retrieves the file content.
        THEN  the call must return a list containing the registered mirrors.
    ...
    def test_get_single_mirror(self):
        ...
        WHEN  the user retrieves the file content.
        THEN  the call must return a list containing only one registered mirror.
